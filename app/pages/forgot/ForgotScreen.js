  ...
  return (
    <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.buttonWrap}>
            <View style={[styles.center, {marginTop: 20, marginBottom: 10}]}>
                <Text style={styles.forgotPassword}>Not Logged User??</Text>
            </View>
        </TouchableOpacity>
            <View style={styles.inputs}>
                ...
                />
                <View style={[styles.center, {marginTop: 20, marginBottom: 10}]}>
                    <Text  numberOfLines={2} style={styles.textContainer}>We will send you an email with a link to reset your password. </Text>
                </View>
                <TouchableOpacity style={styles.buttonWrap}>
                ...
                <TouchableOpacity style={styles.buttonWrap} onPress={this.changeScreen} >
